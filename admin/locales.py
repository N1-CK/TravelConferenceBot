...
TEXTS = {
    'ru': {
        ...
        # Affiliate
        'affiliate_bookings': 'Бронирования Affiliate',
        'affiliate_reports': 'Отчёты Affiliate',
        'affiliate_bookings_title': 'Бронирования ресторанов',
        'affiliate_reports_title': 'Отчёты о встречах',
        ...
        'affiliate_value_card': 'Карта',
        'affiliate_value_cash': 'Наличные',
        'affiliate_value_regular': 'Обычный',
        'affiliate_value_unspecified': 'Не указано',
        'pr_position_en': 'Должность (англ.)',
        'dt_search': 'Поиск:',
        'dt_length': 'Показывать _MENU_ записей',
        'dt_info': 'Записи _START_–_END_ из _TOTAL_',
        'dt_info_empty': 'Записей нет',
        'dt_info_filtered': '(отфильтровано из _MAX_)',
        'dt_empty': 'Нет данных',
        'dt_zero': 'Ничего не найдено',
        'dt_loading': 'Загрузка…',
        ...
        'dt_sort_asc': ': сортировать по возрастанию',
        'dt_sort_desc': ': сортировать по убыванию',
        ...
        'select_conference_placeholder': 'Выберите конференцию...',
        'select_company_placeholder': 'Выберите компанию...',
        'stand_number': 'Номер стенда',
        'stand_number_placeholder': 'Например: B14',
        'stand_style': 'Стиль стенда',
        'stand_style_placeholder': 'Например: Индивидуальный 6x3',
        'working_hours': 'Время работы',
        'working_hours_placeholder': 'Например: 10:00 - 18:00',
        'dress_code': 'Дресс-код',
        'dress_code_placeholder': 'Например: Smart Casual / Корпоративный мерч',
        'stand_photos_label': 'Фотографии стенда / Схема (до 3 фото)',
        'photos_help_text': 'Поддерживаются форматы: PNG, JPG, JPEG, WEBP. Можно выбрать до 3 файлов.',
        'save_stand': 'Сохранить стенд',
        'stands_list_title': 'Список стендов компаний',
        'stands_count_unit': 'стендов',
        'photos': 'Фотографии',
        'no_photos': 'Нет фото',
        'open_full_size': 'Открыть в полном размере',
        'confirm_delete_stand': 'Вы уверены, что хотите удалить стенд компании',
        'no_stands_added': 'Стенды еще не добавлены',
        'edit_stand_title': 'Редактирование стенда',
        'replace_photos_label': 'Заменить фотографии (до 3 файлов, оставьте пустым, чтобы не менять)',
        'max_photos_limit_hint': 'При загрузке новых файлов старые фото будут заменены.',
        'save_changes': 'Сохранить изменения',
        'photo_limit_exceeded': 'Вы можете загрузить не более 3 фотографий!',
        'status_pending_short': 'Ожидание',
        'status_in_progress_short': 'В процессе',
        'status_ready_short': 'Готово',

        'stand_photo_label': 'Фотография стенда / Схема',
        'photo_help_text': 'Поддерживаются форматы: PNG, JPG, JPEG, WEBP.',
        'no_photo': 'Нет фото',
        'replace_photo_label': 'Заменить фотографию (оставьте пустым, чтобы не менять)',
        'replace_photo_hint': 'Загрузка нового файла заменит текущее фото.',

        'all_folders': 'Все',
        'unread_folders': 'Непрочитанные',
        'create_new_folder': 'Создать новую папку',
        'create_folder_title': 'Создать папку',
        'folder_name_label': 'Название папки',
        'folder_name_placeholder': 'Например: VIP, Срочно, PR...',
        'create_folder_btn': 'Создать',
        'chat_folders_title': 'Папки чата',
        'chat_folders_select_hint': 'Выберите, в каких ваших папках будет находиться этот пользователь:',
        'no_folders_hint': 'У вас пока нет папок. Создайте их кнопкой "+" в панели над чатами.',
        'done_btn': 'Готово',
        'archive_header': 'Архив чатов',
        'archive_desc': 'Архивированные переписки',
        'back_to_all_chats': 'Вернуться ко всем чатам',
        'back_to_chats': 'Назад к чатам',
        'manage_chat_folders': 'Настроить папки чата',
        'folders': 'Папки',
        ...
        'confirm_delete_folder': 'Удалить папку "{}"? Сами диалоги удалены не будут.',
        'error_create_folder': 'Ошибка при создании папки',
        'new_message_from': 'Новое сообщение от',
        'new_message_title': 'Новое сообщение',

        # PR-панель (pr_panel.html)
        'status_pending_badge': 'Ожидание',
        'status_in_progress_badge': 'В процессе',
        'status_ready_badge': 'Готово',
        'view': 'Просмотр',

        # Пользователи (users.html)
        'edit_company': 'Изменить организацию',
        'enter_new_company': 'Введите новую организацию:',
        'company_changed_success': 'Организация успешно изменена!',
        'company_changed_error': 'Ошибка при обновлении организации',
        'registered_at': 'Дата регистрации',
        'requests': 'Заявки',
        'type': 'Тип',

        # Base & Уведомления (base.html)
        'notification': 'Уведомление',
        'error': 'Ошибка',

        # Общие действия и элементы интерфейса
        'hide': 'Скрыть',
        'show': 'Показать',
        'no_data_simple': 'Нет данных',
        'and_more_users': '... и еще {} пользователей',
        'and_more_participants': '... и еще {} участников',
        'link_text_default': 'ссылка',
        'bold': 'Жирный',
        'italic': 'Курсив',
        'code': 'Код',
        'link': 'Ссылка',
        'emoji': 'Смайлик',
        'tooltip_bold': 'Жирный (Ctrl+B)',
        'tooltip_italic': 'Курсив (Ctrl+I)',
        'tooltip_code': 'Моноширинный код',
        'tooltip_link': 'Вставить ссылку',
        'tooltip_emoji': 'Смайлики',
        'prompt_insert_link_url': 'Введите URL ссылки:',
        'prompt_insert_link_text': 'Введите текст ссылки:',

        # Подтверждения рассылки (broadcast.html)
        'confirm_send_all': 'Отправить сообщение ВСЕМ пользователям?',
        'confirm_send_companies': 'Отправить сообщение пользователям компаний: {}?',
        'confirm_send_users': 'Отправить сообщение выбранным пользователям ({})?',
        'confirm_send_conferences': 'Отправить сообщение участникам конференций: {}?',

        # Управление менеджерами (admin_managers.html)
        'managers_management': 'Управление менеджерами',
        'add_manager': 'Добавить менеджера',
        'edit_manager': 'Редактировать менеджера',
        'total_managers': 'Всего менеджеров',
        'active_managers': 'Активных',
        'access_groups': 'Групп доступа',
        'managers_list': 'Список менеджеров',
        'login': 'Логин',
        'access_groups_col': 'Группы доступа',
        'last_login': 'Последний вход',
        'reset_password': 'Сброс пароля',
        'confirm_delete_manager': 'Удалить менеджера? Это действие нельзя отменить.',
        'leave_empty_to_keep': 'оставьте пустым, чтобы не менять',

        # Администрирование пользователей (admin_users.html)
        'add_user': 'Добавить пользователя',
        'edit_user': 'Редактировать пользователя',
        'leave_empty': 'оставьте пустым, если не меняется',
        'role': 'Роль',
        'active': 'Активен',
    ...
    'en': {
        ...
        'affiliate_bookings_title': 'Restaurant Bookings',
        'affiliate_reports_title': 'Meeting Reports',
        ...
        'affiliate_value_card': 'Card',
        'affiliate_value_cash': 'Cash',
        'affiliate_value_regular': 'Regular',
        'affiliate_value_unspecified': 'Not specified',
        'pr_position_en': 'Position (English)',
        'dt_search': 'Search:',
        'dt_length': 'Show _MENU_ entries',
        'dt_info': 'Showing _START_–_END_ of _TOTAL_ entries',
        'dt_info_empty': 'No entries',
        'dt_info_filtered': '(filtered from _MAX_ entries)',
        'dt_empty': 'No data available',
        'dt_zero': 'No matching entries',
        'dt_loading': 'Loading…',
        ...
        'dt_sort_asc': ': sort ascending',
        'dt_sort_desc': ': sort descending',
        ...
        'booths_tab_title': 'Company Booths',
        'export_excel': 'Export to Excel',
        'export_excel_title': 'Export to Excel',
        'add_edit_stand': 'Add / Update Booth',
        'conference': 'Conference',
        'select_conference_placeholder': 'Select conference...',
        'select_company_placeholder': 'Select company...',
        'stand_number': 'Booth Number',
        'stand_number_placeholder': 'e.g. B14',
        'stand_style': 'Booth Style',
        'stand_style_placeholder': 'e.g. Custom 6x3',
        'working_hours': 'Working Hours',
        'working_hours_placeholder': 'e.g. 10:00 - 18:00',
        'dress_code': 'Dress Code',
        'dress_code_placeholder': 'e.g. Smart Casual / Branded Merch',
        'stand_photos_label': 'Booth Photos / Layout (Up to 3 photos)',
        'photos_help_text': 'Supported formats: PNG, JPG, JPEG, WEBP. You can upload up to 3 files.',
        'save_stand': 'Save Booth',
        'stands_list_title': 'Company Booths List',
        'stands_count_unit': 'booths',
        'photos': 'Photos',
        'no_photos': 'No photos',
        'open_full_size': 'Open full size',
        'confirm_delete_stand': 'Are you sure you want to delete booth for company',
        'no_stands_added': 'No booths added yet',
        'edit_stand_title': 'Edit Booth',
        'replace_photos_label': 'Replace photos (up to 3 files, leave empty to keep current)',
        'max_photos_limit_hint': 'Uploading new files will replace current photos.',
        'save_changes': 'Save Changes',
        'photo_limit_exceeded': 'You can upload a maximum of 3 photos!',
        'status_pending_short': 'Pending',
        'status_in_progress_short': 'In Progress',
        'status_ready_short': 'Ready',

        'stand_photo_label': 'Booth Photo / Layout',
        'photo_help_text': 'Supported formats: PNG, JPG, JPEG, WEBP.',
        'no_photo': 'No photo',
        'replace_photo_label': 'Replace photo (leave empty to keep current)',
        'replace_photo_hint': 'Uploading a new file will replace the current photo.',

        # Chats and folders (user_chats.html)
        'all_folders': 'All',
        'unread_folders': 'Unread',
        'create_new_folder': 'Create new folder',
        'create_folder_title': 'Create Folder',
        'folder_name_label': 'Folder name',
        'folder_name_placeholder': 'e.g. VIP, Urgent, PR...',
        'create_folder_btn': 'Create',
        'chat_folders_title': 'Chat Folders',
        'chat_folders_select_hint': 'Select which of your folders this user belongs to:',
        'no_folders_hint': 'You have no folders yet. Create them using the "+" button above the chats.',
        'done_btn': 'Done',
        'archive_header': 'Chat Archive',
        'archive_desc': 'Archived conversations',
        'back_to_all_chats': 'Return to all chats',
        'back_to_chats': 'Back to chats',
        'manage_chat_folders': 'Configure chat folders',
        'folders': 'Folders',
        ...
        'confirm_delete_folder': 'Delete folder "{}"? Chats will not be deleted.',
        'error_create_folder': 'Error creating folder',
        'new_message_from': 'New message from',
        'new_message_title': 'New message',

        # PR Panel (pr_panel.html)
        'status_pending_badge': 'Pending',
        'status_in_progress_badge': 'In Progress',
        'status_ready_badge': 'Ready',
        'view': 'View',

        # Users (users.html)
        'edit_company': 'Edit company',
        'enter_new_company': 'Enter new company:',
        'company_changed_success': 'Company updated successfully!',
        'company_changed_error': 'Error updating company',
        'registered_at': 'Registered At',
        'requests': 'Requests',
        'type': 'Type',

        # Base & Notifications (base.html)
        ...
        'hide': 'Hide',
        'show': 'Show',
        'no_data_simple': 'No data',
        'and_more_users': '... and {} more users',
        'and_more_participants': '... and {} more participants',
        'link_text_default': 'link',
        'bold': 'Bold',
        'italic': 'Italic',
        'code': 'Code',
        'link': 'Link',
        ...
        'tooltip_code': 'Monospace code',
        'tooltip_link': 'Insert link',
        'tooltip_emoji': 'Emojis',
        'prompt_insert_link_url': 'Enter link URL:',
        'prompt_insert_link_text': 'Enter link text:',

        # Broadcast confirmations (broadcast.html)
        'confirm_send_all': 'Send message to ALL users?',
        'confirm_send_companies': 'Send message to users of companies: {}?',
        'confirm_send_users': 'Send message to selected users ({})?',
        'confirm_send_conferences': 'Send message to participants of conferences: {}?',

        # Managers management (admin_managers.html)
        'managers_management': 'Manage Managers',
        ...
        'login': 'Login',
        'access_groups_col': 'Access Groups',
        'last_login': 'Last Login',
        'reset_password': 'Reset Password',
        'confirm_delete_manager': 'Delete manager? This action cannot be undone.',
        'leave_empty_to_keep': 'leave empty to keep unchanged',

        # Admin users (admin_users.html)
        'add_user': 'Add User',
        'edit_user': 'Edit User',
        'leave_empty': 'leave empty if unchanged',
        'role': 'Role',
        'active': 'Active',
        'blocked': 'Blocked',
    }
